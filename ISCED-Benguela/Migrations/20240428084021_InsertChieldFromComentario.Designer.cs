...
namespace ISCED_Benguela.Migrations
{
    ...
    [Migration("20240428084021_InsertChieldFromComentario")]
    partial class InsertChieldFromComentario
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ISCED_Benguela.Modelos.RedesSociais", b =>
                {
                    ...
                    b.ToTable("RedeSociai");
                });

            modelBuilder.Entity("ISCED_Benguela.Modelos.Register", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ISCED_Benguela.Modelos.Disciplina", b =>
                {
                    ...
                    b.HasOne("ISCED_Benguela.Modelos.Professores", null)
            ...
            modelBuilder.Entity("ISCED_Benguela.Modelos.Estudantes", b =>
                {
                    ...
                    b.HasOne("ISCED_Benguela.Modelos.Register", "RegisterLogin")
                        .WithMany()
